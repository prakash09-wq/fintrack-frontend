export default function Landing({ onGetStarted }) {
  const features = [
    ...
    { ic: "📊", h: "Financial Health Score", p: "Get a score out of 100 based on your savings rate, budget compliance, debt load and goal progress. Updates live as you add data." },
  ];
  ...
  return (
    <div className="land">
      ...
      <section className="land-hero">
        <div className="hero-badge"><span className="hero-dot" />&nbsp;Real-time Financial Health Score inside</div>
        ...
        <div className="hero-stats">
          {[{ v: "Free", l: "Forever, no catch" }, { v: "8", l: "Finance modules" }, { v: "100%", l: "Data stays local" }, { v: "Live", l: "Health score" }].map((s, i) => (
      ...
      <section className="land-sec">
        <div className="land-sec-inner">
          ...
          <p className="land-sec-p">Not just a ledger — a full financial cockpit with live charts, loan trackers, calendar view, goal planners and smart financial insights.</p>
